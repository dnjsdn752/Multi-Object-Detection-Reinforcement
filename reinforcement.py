...
Transition = namedtuple('Transition', ('state', 'action', 'next_state', 'agent1_reward', 'agent2_reward')) #collabo: reward -> agent1_reward, agent2_reward
...
def get_multi_reward_sum(rewards):
    return sum(rewards)
